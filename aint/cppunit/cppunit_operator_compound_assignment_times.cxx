...
void aintTest::testOperatorCompoundAssignmentTimes()
{
    *a1 = 3; CPPUNIT_ASSERT( (*a1 *= aint(4)) == 12 );
    *a1 = 3; CPPUNIT_ASSERT( (*a1 *= "4")  == 12 );
    *a1 = 3; CPPUNIT_ASSERT( (*a1 *= std::string("4")) == 12 );
    *a1 = 3; CPPUNIT_ASSERT( (*a1 *= 4)    == 12 );
    *a1 = 3; CPPUNIT_ASSERT( (*a1 *= 4L)   == 12 );
    *a1 = 3; CPPUNIT_ASSERT( (*a1 *= 4LL)  == 12 );
    *a1 = 3; CPPUNIT_ASSERT( (*a1 *= 4U)   == 12 );
    *a1 = 3; CPPUNIT_ASSERT( (*a1 *= 4UL)  == 12 );
    *a1 = 3; CPPUNIT_ASSERT( (*a1 *= 4ULL) == 12 );
    *a1 = 3; CPPUNIT_ASSERT( ((*a1 *= "4") *= "5") == 60 );
}
