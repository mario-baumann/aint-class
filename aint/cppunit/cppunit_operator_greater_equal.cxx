...
void aintTest::testOperatorGreaterEqual() {

    // Less-Equal tests with mirrored arguments
    ...
    CPPUNIT_ASSERT( aint("+1000000") >=  1000000UL  );
    CPPUNIT_ASSERT( aint("+2000000") >=  1000000UL  );
    CPPUNIT_ASSERT( aint("+1000000") >=        0UL  );
    CPPUNIT_ASSERT( aint("+1000000") >=  1000000ULL );
    ...
    CPPUNIT_ASSERT( aint("+1000000000000") >=  1000000000000U   );
    CPPUNIT_ASSERT( aint("+2000000000000") >=  1000000000000U   );
    CPPUNIT_ASSERT( aint("+1000000000000") >=              0U   );
    CPPUNIT_ASSERT( aint("+1000000000000") >=  1000000000000UL  );
