...
public:
    ...
    void testOperatorCompoundAssignment();
    void testFibonacci();
    static CppUnit::TestSuite *suite() {
        ...
        suiteOfTests->addTest(new CppUnit::TestCaller<aintTest>("testCompoundAssignment", &aintTest::testOperatorCompoundAssignment));
