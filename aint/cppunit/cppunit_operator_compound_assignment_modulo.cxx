...
void aintTest::testOperatorCompoundAssignmentModulo()
{
    *a1 = 13; CPPUNIT_ASSERT( (*a1 %= aint(2)) == 1 );
    *a1 = 13; CPPUNIT_ASSERT( (*a1 %= "2")  == 1 );
    *a1 = 13; CPPUNIT_ASSERT( (*a1 %= std::string("2")) == 1 );
    *a1 = 13; CPPUNIT_ASSERT( (*a1 %= 2)    == 1 );
    *a1 = 13; CPPUNIT_ASSERT( (*a1 %= 2L)   == 1 );
    *a1 = 13; CPPUNIT_ASSERT( (*a1 %= 2LL)  == 1 );
    *a1 = 13; CPPUNIT_ASSERT( (*a1 %= 2U)   == 1 );
    *a1 = 13; CPPUNIT_ASSERT( (*a1 %= 2UL)  == 1 );
    *a1 = 13; CPPUNIT_ASSERT( (*a1 %= 2ULL) == 1 );
    *a1 = 17; CPPUNIT_ASSERT( ((*a1 %= "4") %= "2") == 1 );
}
