...
void aintTest::testOperatorDecrement() {

    CPPUNIT_ASSERT( --aint(   "-1") ==    -2 );
    CPPUNIT_ASSERT( --aint(    "0") ==    -1 );
    CPPUNIT_ASSERT( --aint(    "1") ==     0 );
    CPPUNIT_ASSERT( --aint( "9999") ==  9998 );
    CPPUNIT_ASSERT( --aint("10000") ==  9999 );
    CPPUNIT_ASSERT( --aint("10001") == 10000 );
    ...
    CPPUNIT_ASSERT( aint("10001")-- == 10001 );
